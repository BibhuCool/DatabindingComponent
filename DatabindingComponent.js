        ...
        <>
            ...
            <div>
                ...
                <ol className="list-unstyled">
                    {
                        catagories.map(catagory=>
                       <li key={catagory}><input type="checkbox" /><span>{catagory}</span></li>
                        )
                    }
                </ol>
            </div>
            ...
            <dl>
                ...
                <dd>{product.title}</dd>
                <dt>Preview</dt>
                <dd><img alt="Product Preview" src={product.image} width='100' height='100' /></dd>
                <dt>Rating</dt>
            ...
            <div className="d-flex flex-wrap">
            {
                ...
                <img alt="Preview" src={product.image} className="card-img-top" height='200' />
                <div className="card-header">
                <p>{product.title}</p>
                </div>
                <div className="card-footer">
                <button className="btn btn-danger w-100"><span className="bi bi-cart-4"></span>Add to Cart</button>
